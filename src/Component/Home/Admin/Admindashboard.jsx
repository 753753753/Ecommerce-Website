...
function Admindashboard() {
    ...
    const {getproduct , getorder , getuser} = useData()
        ...
        <div className='mb-20'>
            <div>
                ...
                <div className="top mb-5 px-5 mt-5">
                    <div className=" bg-gradient-to-r from-gray-800 to-red-600 py-5 border border-pink-100 rounded-lg">
                        ...
                        <Tabs>
                            <TabList className="flex flex-wrap -m-4 text-center justify-center">
                                ...
                                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                    <div className=" border  bg-gradient-to-r from-gray-800 to-red-600 py-5 hover:bg-pink-100 border-pink-100 px-4 rounded-xl" >
                                        ...
                                        <h2 className="title-font font-medium text-3xl text-white fonts1" >{getproduct.length}</h2>
                                        <p className=" text-white  font-bold" >Total Products</p>
                                    </div>
                                </Tab>
                                {/* Total Order  */}
                                <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                    <div className=" border  bg-gradient-to-r from-gray-800 to-red-600 py-5 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                        <div className="text-black w-12 h-12 mb-3 inline-block" >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={50}
                                        ...
                                        <h2 className="title-font font-medium text-3xl text-white fonts1" >{getorder.length}</h2>
                                ...
                                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                    <div className=" border  bg-gradient-to-r from-gray-800 to-red-600 py-5 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl" >
                                        ...
                                        <h2 className="title-font font-medium text-3xl text-white fonts1" >{getuser.length}</h2>
